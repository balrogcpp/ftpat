...
// const static string sublot = "D40880";
// const static string baselot = sublot;
...
// clang++ -s -static-libstdc++ -O3 -funroll-loops -std=c++23 -ftree-vectorize -march=native -flto -pthread -fopenmp -I include -ltbb pat2.cpp main.cpp -no-pie -o test && time ./test
int main()
{
